      ...
      ({
        ...
        const material = useMemo(() => {
          const getUniforms = (): Record<
            string,
            { value: THREE.Vector2 | THREE.Vector3 | number | THREE.Vector3[] | number[]; type?: string }
          > => {
...
const Shader = dynamic(
  () =>
    Promise.resolve(({ source, uniforms, maxFps = 60 }: ShaderProps) => {
      return (
...
// CanvasRevealEffect component with client-side check
