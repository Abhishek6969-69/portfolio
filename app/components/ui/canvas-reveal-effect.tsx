...
const ShaderMaterial = dynamic(() => Promise.resolve(({
  source,
  uniforms,
  maxFps = 60,
}: {
...
const Shader = dynamic(() => Promise.resolve(({ source, uniforms, maxFps = 60 }: ShaderProps) => {
  return (
...
const DotMatrix = dynamic(() => Promise.resolve(({
  colors = [[0, 0, 0]],
